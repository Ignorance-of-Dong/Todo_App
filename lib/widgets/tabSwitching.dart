 ...
 * @LastEditTime: 2020-12-30 14:37:04
...
class TabSwitching extends StatefulWidget {
  final context;
  TabSwitching({Key key, @required this.context}) : super(key: key);
  @override
...
class _TabSwitchingState extends State<TabSwitching>
  ...
  runAnimation(screenWid, start, end) {
    ...
    animation = Tween<double>(begin: screenWid * start, end: screenWid * end)
